...
<div
        ...
        while ($res = $sql->fetch(PDO::FETCH_OBJ)):
            ?>
            <div class='big_center_text horoscope_block' data-aos="fade-up" data-aos-duration="1000" style="background:white">
                <h2>
                    <?php echo $res->sing; ?>
                </h2>
                <p>
        ...
        <?php endwhile ?>
        <div class='gr_curcle' style='top:30%; left: 15%; background:white'></div>
    </div>
